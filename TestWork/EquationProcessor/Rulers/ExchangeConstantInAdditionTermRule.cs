...
{
    public class ExchangeConstantInAdditionTermRule : IRule
    {
        ...
        private static bool MatchShiftLeft(EquationBinaryOperationBase operation) =>
            operation.Right is EquationBinaryOperationBase tOperation &&
            tOperation.Type == OperationsEnum.Addition &&
            tOperation.Left is EquationVariable &&
            tOperation.Right is EquationConstant &&
